...
function(newArticle) {
        ...
        $(".navigation").appendTo(".index").css("display","block"); //navigationをwrapperの一番最後に移動して表示
});
